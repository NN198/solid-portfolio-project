...
This prepared dataset being tested against the RADAR detector(Refer Paper <a href="https://arxiv.org/abs/2307.03838">https://arxiv.org/abs/2307.03838</a>) which not only described the accuracy of precision of 91% and recall of 90% for few-shot tasks
